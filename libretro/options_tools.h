 ...
 * The function is exposed with overrides and return boolean, string or int.
...
static constexpr const char* INT_PCSX2_OPT_SPEEDHACKS_PRESET = "pcsx2_speedhacks_preset";
