...
void mVUclamp2_SSE4(microVU& mVU, const xmm& reg, const xmm& regT1in, int xyzw, bool bClampE = 0)
{
...
void mVUclamp2_C(microVU& mVU, const xmm& reg, const xmm& regT1in, int xyzw, bool bClampE = 0)
{
	if ((!clampE && CHECK_VU_SIGN_OVERFLOW) || (clampE && bClampE && CHECK_VU_SIGN_OVERFLOW)) {
...
void (*mVUclamp2)(microVU& mVU, const xmm& reg, const xmm& regT1in, int xyzw, bool bClampE);
