...
typedef  void vtlbMemR64FP(u32 addr,mem64_t* data);
typedef  void vtlbMemR128FP(u32 addr,mem128_t* data);
...
extern void vtlb_memRead64(u32 mem, mem64_t *out);
extern void vtlb_memRead128(u32 mem, mem128_t *out);
